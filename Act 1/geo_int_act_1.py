...
ax1.bar(df['date'], df['rainfall_mm'], label='Rainfall')

ax2 = ax1.twinx()
ax2.plot(df['date'], df['temperature_max'], marker='o', label='Max Temp')
ax2.plot(df['date'], df['temperature_min'], marker='x', label='Min Temp')
